...
@implementation NSBundle (TVUMJRefresh)
+ (instancetype)mj_refreshBundle
{
    static NSBundle *refreshBundle = nil;
    if (refreshBundle == nil) {
        // 这里不使用mainBundle是为了适配pod 1.x和0.x
        refreshBundle = [NSBundle bundleWithPath:[[NSBundle bundleForClass:[TVUMJRefreshComponent class]] pathForResource:@"TVUMJRefresh" ofType:@"bundle"]];
    }
